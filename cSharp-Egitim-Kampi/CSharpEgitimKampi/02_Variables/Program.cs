...
namespace _02_Variables
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Alışverişinizin Toplam Tutarı: "+shoppingTotalPrice+ " TL");
            ...
            //Console.WriteLine("-------------------------------------");
            //Console.WriteLine("Yolcu T.C Kimlik Numarası: " + passengerIdentityNumber + " - Yolcu Ad Soyad: " + passengerName + " " + passengerSurname + " " + passengerDistrict + " " + passengerCity + " " + passengerAge);
